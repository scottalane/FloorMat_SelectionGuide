...
function myFunction() {
    ...
    var lb = document.getElementById("lightbox_window_ss");
    lb.hidden = true;
    lb.onclick = HideLightBox;

    var transporterWashRack = document.getElementById("transporterWashRack");
    transporterWashRack.onclick = ShowLightBox;
