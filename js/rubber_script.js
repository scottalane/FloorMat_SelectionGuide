...
function myFunction() {
    ...
    var lb = document.getElementById("lightbox_window_tt");
    lb.hidden = true;
    lb.onclick = HideLightBox;

    var cleaningSupplies1 = document.getElementById("cleaningSupplies1");
    cleaningSupplies1.onclick = ShowLightBox;
