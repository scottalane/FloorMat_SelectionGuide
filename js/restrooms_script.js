...
function myFunction() {
    ...
    function myFunction() {
    //alert("I am now in JS land. Code me up!");
    var lb = document.getElementById("lightbox_window_rr");
    lb.hidden = true;
    lb.onclick = HideLightBox;

    var saniMate = document.getElementById("saniMate");
    saniMate.onclick = ShowLightBox;
